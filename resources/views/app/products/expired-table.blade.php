@forelse ($products as $product)
    <tr>
        ...
        <td>{{ $product->manufacturer_date ?? 'no data' }}</td>
        <td>{{ $product->expiry_date ?? 'no data' }}</td>
        @php
        ...
        <td class="action-table-data">
            <div class="edit-delete-action">
                <a data-id="{{ $product->id }}" data-item_code="{{ $product->item_code }}"
                    data-product_name="{{ $product->product_name }}"
                    data-manufacturer_date="{{ $product->manufacturer_date }}"
                    data-expiry_date="{{ $product->expiry_date }}" data-bs-toggle="modal"
