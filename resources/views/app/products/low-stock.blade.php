<x-app-layout>
    ...
    @section('content')
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    ...
                    <li>
						<a href="#" id="sendviaMail" class="btn btn-secondary w-auto shadow-none"
                        {{-- data-bs-toggle="modal" data-bs-target="#send-email" --}}
                        ><i data-feather="mail" class="feather-mail"></i>Send Email</a>
					</li>
                </ul>
                                ...
                                <div
                                    ...
                                    <div class="dropdown me-2">
                                        ...
                                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                                            ...
                                            @empty
                                                <li>
                                                    <a href="javascript:void(0);" class="dropdown-item rounded-1">Categories
                                                        not
                                                        available</a>
                                                </li>
                                            @endforelse
                                    ...
                                    <div class="table-wrapper position-relative">
                                        ...
                                        <table class="table datatable">
                                            ...
                                            <tbody id="product-table-body" class="">
                                                @include('app.products.low-stock-table')
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table datatable">
                                        ...
                                        <tbody id="product-table-body" class="">
                                            @include('app.products.out-stock-table')
                                        </tbody>
                                    </table>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="edit-expired-product">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('low-stock.product.edit') }}" method="post">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <input type="text" name="quantity" class="form-control" id="edit_qty">
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label">Qty Alert<span class="text-danger ms-1">*</span></label>
                                    <input type="text" name="quantity_alert" class="form-control"
                                        id="edit_qty_alert">
                                </div>
                            </div>
                        </div>
		...
		<div class="modal fade" id="send-email">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="success-email-send modal-body text-center">
						<span class="rounded-circle d-inline-flex p-2 bg-success-transparent mb-2"><i class="ti ti-checks fs-24 text-success"></i></span>
						<h4 class="fs-20 fw-semibold">Success</h4>
						<p>Email Sent Successfully</p>
						<a href="#" class="btn btn-primary p-1 px-2 fs-13 fw-normal" data-bs-dismiss="modal">Close</a>
					</div>
				</div>
			</div>
		</div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                editButtons.forEach(btn => {
                    btn.addEventListener('click', function() {
                        ...
                        const quantity_alert = this.dataset.quantity_alert;
                        ...
                        document.getElementById('edit_qty_alert').value = quantity_alert;
                    });
                });
            });
        </script>
            ...
            $(document).ready(function() {
                function submitExportForm(route) {
                    ...
                    if (selectedIds.length === 0) {
                        toastr.warning("Please select at least one product to export | Email.");
                        return;
                    }
                ...
                $("#sendviaMail").on("click", function() {
                    submitExportForm('{{ route('products.sendviaEmail') }}');
                });
