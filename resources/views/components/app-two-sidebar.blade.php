						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade" id="stock">
								<ul>
									...
									<li><a href="{{route('manage_stock')}}"><span>Manage Stock</span></a></li>
									<li><a href="{{route('stock.adjustment')}}"><span>Stock Adjustment</span></a></li>
									<li><a href="{{route('stock.transfer')}}"><span>Stock Transfer</span></a></li>
								</ul>
							</div>
							<div class="tab-pane fade" id="sales">
								<ul>
									...
									<li class="submenu">
										...
										<ul>
											<li><a href="{{ route('sales') }}">Online Orders</a></li>
							...
							<div class="tab-pane fade" id="hrm">
								<ul>
									...
									<li><a href="{{route('employee.list')}}"><span>Employees</span></a></li>
