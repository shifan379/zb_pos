           ...
           <li class="nav-item dropdown link-nav">
           	...
           	<div class="dropdown-menu dropdown-xl dropdown-menu-center">
           		<div class="row g-2">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('product.create') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('purchase') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('sales') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('expenses.index') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('quotation.index') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('users.index') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('customer') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('employee.create') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('suppliers') }}" class="link-item">
           					<span class="link-icon">
           			...
           			<div class="col-md-2">
           				<a href="{{ route('stock.transfer') }}" class="link-item">
           					<span class="link-icon">
            ...
            <li class="nav-item pos-nav">
                ...
                <a href="{{ route('sales') }}" class="btn btn-primary btn-md d-inline-flex align-items-center">
                    <i class="ti ti-device-laptop me-1"></i>Sales
                </a>
            </li>
            ...
            <li class="nav-item dropdown has-arrow main-drop profile-nav">
                ...
                <div class="dropdown-menu menu-drop-user">
                    ...
                    <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                        class="dropdown-item logout pb-0" href="#"><i class="ti ti-logout me-2"></i>Logout</a>
                </div>
            </li>
        </ul>
        <!-- /Header Menu -->
