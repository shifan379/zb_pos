...
class FilteredSalesExport implements FromCollection, WithHeadings
{
    protected $productId, $startDate, $endDate;

    public function __construct($productId, $startDate, $endDate)
    {
